...
//$ref = $_GET['leaveid'];
$sql = "SELECT EmailId from tblemployees join tblleaves on tblemployees.id = tblleaves.empid and tblleaves.id=:did";
...
if($status==1){
mail($sm,"approved","Leave approved for reference no : $did\n\n Remarks : $description ");}
if($status==2){mail($sm,"not approved","Leave not approved for reference no : $did\n\n Remarks : $description");}
}
}
