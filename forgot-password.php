...
$data="SELECT EmailId FROM tblemployees WHERE id=:empid";
                ...
                <nav class="cyan darken-1">
                    <div class="nav-wrapper row">
                        ...
                        <div class="header-title col s5">
                            <span class="chapter-title"><a href="index.php"><img src="150dpi.png" height=60px align="left"></a>&nbsp &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspINDIAN INSTITUTE OF INFORMATION TECHNOLOGY, &nbspBHAGALPUR</span>
                        </div>
                                  ...
                                  <div class="card-content ">
                                      <span class="card-title" style="font-size:20px;">Student details</span>
                                       ...
                                       <div class="row">
                                           ...
                                           ************** OTP will be sent to this mail id **************
                                      </div>
                                  </div>
...
foreach ($results as $result) {
  ...
  //////////////
    ...
    $ms="OTP for password change";
    $ms1="$otp is OTP for password change of Student Leave Management System at IIIT BH.";
    mail($email,$ms,$ms1);
    //echo $otp." OTPP";
  //////////////
 ...
 <div class="row">
    ...
    <form class="col s12" name="udatepwd" method="post">
      ...
      <div class="input-field col s12">
      <input id="key" type="number" name="key" autocomplete="off" required>
                                                    <label for="key">OTP</label>
                                                </div>
...
<?php } ?>
                ...
                <marquee>designed and developed by Kanishk Tyagi, Saichethan M. Reddy and Hemanth Varma</marquee>
