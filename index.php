...
<html lang="en">
    <head>
       ...
       <link rel="manifest" href="/Student-Leave-Management-System-/manifest.json">
    ...
    <body>
        ...
        <div class="mn-content fixed-sidebar">
            ...
            <marquee><b>designed and developed by Kanishk Tyagi, Saichethan M. Reddy and Hemanth Varma</b></marquee>
...
<div id="installContainer" class="hidden">
    ...
    <script src="/Student-Leave-Management-System-/script.js" defer></script>
        ...
        <!-- Footer -->
                    <footer id="footer">
                        <p class="copyright">&copy; IIIT BHAGALPUR</p>
                    </footer>
